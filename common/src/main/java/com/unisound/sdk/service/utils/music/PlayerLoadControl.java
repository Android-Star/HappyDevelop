...
public class PlayerLoadControl implements LoadControl {
  ...
  public static final int BUFFER_SCALE_UP_FACTOR = 4;
  /**
  ...
  public static final class Builder {
     ...
     * @return This builder, for convenience.
     */
    public Builder setBufferDurationsMs(int minBufferMs, int maxBufferMs,
        int bufferForPlaybackMs, int bufferForPlaybackAfterRebufferMs) {
     ...
     * size will be calculated using {@link #calculateTargetBufferSize(Renderer[], * TrackSelectionArray)}.
     *
     ...
     * @return This builder, for convenience.
     */
    public Builder setPrioritizeTimeOverSizeThresholds(
    ...
    public Builder setPriorityTaskManager(
    ...
    public DefaultLoadControl createDefaultLoadControl() {
      ...
      return new DefaultLoadControl(allocator, minBufferMs, maxBufferMs, bufferForPlaybackMs,
  ...
  @Deprecated public PlayerLoadControl(DefaultAllocator allocator) {
  ...
  /** @deprecated Use {@link DefaultLoadControl.Builder} instead. */
  @Deprecated public PlayerLoadControl(DefaultAllocator allocator, int minBufferMs, int maxBufferMs,
      int bufferForPlaybackMs, int bufferForPlaybackAfterRebufferMs, int targetBufferBytes,
      boolean prioritizeTimeOverSizeThresholds) {
    this(allocator, minBufferMs, maxBufferMs, bufferForPlaybackMs, bufferForPlaybackAfterRebufferMs,
        targetBufferBytes, prioritizeTimeOverSizeThresholds, null);
  }

  /** @deprecated Use {@link DefaultLoadControl.Builder} instead. */
  @Deprecated public PlayerLoadControl(DefaultAllocator allocator, int minBufferMs, int maxBufferMs,
      int bufferForPlaybackMs, int bufferForPlaybackAfterRebufferMs, int targetBufferBytes,
      boolean prioritizeTimeOverSizeThresholds, PriorityTaskManager priorityTaskManager) {
    assertGreaterOrEqual(bufferForPlaybackMs, 0, "bufferForPlaybackMs", "0");
    assertGreaterOrEqual(bufferForPlaybackAfterRebufferMs, 0, "bufferForPlaybackAfterRebufferMs",
        "0");
    assertGreaterOrEqual(minBufferMs, bufferForPlaybackMs, "minBufferMs", "bufferForPlaybackMs");
    assertGreaterOrEqual(minBufferMs, bufferForPlaybackAfterRebufferMs, "minBufferMs",
  ...
  @Override public void onTracksSelected(Renderer[] renderers, TrackGroupArray trackGroups,
      TrackSelectionArray trackSelections) {
    targetBufferSize =
        targetBufferBytesOverwrite == C.LENGTH_UNSET ? calculateTargetBufferSize(renderers,
            trackSelections) : targetBufferBytesOverwrite;
  ...
  @Override public long getBackBufferDurationUs() {
    return 0;
  }

  @Override public boolean retainBackBufferFromKeyframe() {
    return false;
  }
  ...
  @Override public boolean shouldStartPlayback(long bufferedDurationUs, float playbackSpeed,
      boolean rebuffering) {
   ...
   */
  protected int calculateTargetBufferSize(Renderer[] renderers,
