    ...
    Handler han = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if (time < 0) {
                ...
                TimeButton.this.setBackground(mContext.getDrawable(R.drawable.public_login_captcha_btn));
...
//        Toast.makeText(mContext, "计时结束", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        ...
        this.setBackground(mContext.getDrawable(R.drawable.public_login_captcha_btn_no));
