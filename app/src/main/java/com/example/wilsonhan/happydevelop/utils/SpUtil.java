...
public class SpUtil {
    ...
    public static final String FILE_PATH =
            MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    ? AppApplication.getAppContext().getExternalFilesDir("SpFiles/").getAbsolutePath()
                    : AppApplication.getAppContext().getFilesDir() + File.separator + "SpFiles/";
    /**
     * 医生的公共的sharedpreference
     */
    public static final String MY_SP = "doctor_sp";
    /**
     * 公共的sharedpreference
     */
