...
import com.example.wilsonhan.happydevelop.utils.AudioManager;
import com.example.wilsonhan.happydevelop.utils.DialogManager;
...
public class RecordButton extends Button implements AudioManager.AudioStateListener {
    ...
    public RecordButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        String dir = context.getCacheDir() + "/answer_record_local";
        audioManager = AudioManager.getInstence(dir);
        audioManager.setAudioStateListener(RecordButton.this);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_VOICE_CHANGE:
                    int voice = audioManager.getVoiceLevel(7);
                    LogUtils.logi("RecordButton" + voice);
                    mDialogManager.setLevel(voice);
                    break;
